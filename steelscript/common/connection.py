...
# TODO: Fix properly. Temporary following warning will just be logged "InsecureRequestWarning: Unverified HTTPS request. Adding certificate verification is strongly advised. See: https://urllib3.readthedocs.io/en/latest/advanced-usage.html#tls-warnings"
